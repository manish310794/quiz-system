                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <ul style="width:50%;" class="list-group">
						  ...
						  <li class="list-group-item"><strong>Duration</strong>: <?php echo $quiz->getDuration(); ?> mins</li>
                  ...
                  <div class="panel-heading"><h3>Questions:</h3></div>
                    ...
                    <table id="questions" class="table table-striped table-responsive">
                          ...
                          <tbody>
							  ...
							  $url = $question->getUrl();?>
                              <tr class="question">
                                  <td class="question"><?php echo $question->getText(); ?>
								  <?php if($question->getType() == 1) {?>
									<br/>
									<br/>
									<iframe width="300" height="200" src="<?php echo $question->getUrl(); ?>" frameborder="0" allowfullscreen></iframe>
								  <?php }
								  else if($question->getType() == 2) { ?>
								  <br/>
								  <br/>
										<img src="<?php echo $root.'/uploads/'.$quiz->getId().'/'.$url; ?>" width="200" height="200">
								  <?php } ?>
								  </td>
                                  <td style="text-align:center;">
                                      <button data-question-id="<?php echo $question->getNum(); ?>" title="Edit Question" class="edit btn btn-default btn-primary" type="button"><span class="glyphicon glyphicon-pencil"></span></button>
          ...
          <div class="modal-header">
            ...
            <div class="modal-body">
				...
				<p>
				   ...
				   <input name="questionurl" id="questionurl" type="text" class="form-control" />
				   <input type="hidden" name="_METHOD" value="PUT" />
				</p>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form id="questionadd" method="post" action="<?php echo $root."/admin/quiz/".$quiz->getId(); ?>" enctype="multipart/form-data">
            <div class="modal-body">
				...
				<p><label for="embed">Embed:</label>
                   <select name="embed" id="embed" class="form-control">
                       <option value="none" selected>None</option>
					   <option value="image">Image</option>
					   <option value="video">Video</option>
                   </select>
                </p>
				<p id="embedvideo"><label for="newquestionurl">Embed Video:</label>
                   <input name="questionurl" id="newquestionurl" type="text" placeholder="Video URL goes here" class="form-control" />
                </p>
				<p id="embedimage"><label for="newquestionimage">Embed Image:</label>
                   <input name="fileToUpload" id="file" type="file" class="form-control" />
                </p>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
				...
				<p><label for="duration">Quiz Duration:</label>
                   <input name="duration" id="duration" type="text" placeholder="Quiz Duration" value="<?php echo $quiz->getDuration(); ?>" class="form-control" />
                </p>
